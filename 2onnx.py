...
def main():
    ...
    torch.nn.utils.remove_weight_norm(model.body[0])
    torch.nn.utils.remove_weight_norm(model.body[1])
    torch.nn.utils.remove_weight_norm(model.body[2])
    torch.nn.utils.remove_weight_norm(model.body[3])
    torch.nn.utils.remove_weight_norm(model.body[4])
    torch.nn.utils.remove_weight_norm(model.body[5])
    torch.nn.utils.remove_weight_norm(model.body[6])
    torch.nn.utils.remove_weight_norm(model.body[7])
