...
def main():
    ...
    torch.nn.utils.remove_weight_norm(model.body[0].body)
    torch.nn.utils.remove_weight_norm(model.body[1].body)
    torch.nn.utils.remove_weight_norm(model.body[2].body)
    torch.nn.utils.remove_weight_norm(model.body[3].body)
    torch.nn.utils.remove_weight_norm(model.body[4].body)
    torch.nn.utils.remove_weight_norm(model.body[5].body)
    torch.nn.utils.remove_weight_norm(model.body[6].body)
    torch.nn.utils.remove_weight_norm(model.body[7].body)
